    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-primary-50 py-8">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white/80 rounded-2xl shadow-xl border-2 border-primary-300 p-6 mb-8 hover:border-primary-500 hover:shadow-glow transition-all duration-300">
            <h2 className="text-2xl font-bold text-primary-900 mb-4">{job.title}</h2>
          ...
          <form onSubmit={handleSubmit} className="bg-white/80 rounded-2xl shadow-xl border-2 border-primary-300 p-6 hover:border-primary-500 hover:shadow-glow transition-all duration-300">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div>
                <label className="block text-primary-700 mb-2">Name</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
                  onChange={handleChange}
                  className={`w-full p-3 border-2 border-primary-300 rounded-lg ${errors.name ? 'border-red-500' : ''}`}
                />
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full p-3 border-2 border-primary-300 rounded-lg ${errors.phone ? 'border-red-500' : ''}`}
              />
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={handleChange}
                accept=".pdf,.doc,.docx"
                className={`w-full p-3 border-2 border-primary-300 rounded-lg ${errors.resume ? 'border-red-500' : ''}`}
              />
