          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full p-3 border-2 border-primary-300 rounded-lg ${errors.confirmPassword ? 'border-red-500' : ''}`}
              />
            ...
            {formData.role === 'employer' && (
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full p-3 border-2 border-primary-300 rounded-lg ${errors.company ? 'border-red-500' : ''}`}
                />
